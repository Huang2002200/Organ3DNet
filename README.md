...
```
## Dataset<br>
The dataset (file 5plant_xyz_ins_sem.rar)((https://doi.org/10.5281/zenodo.17165870) contains 889 colorless point clouds of five crop species (tobacco, tomato, sorghum, soybean, and pepper), including 635 point clouds for training (folder Area_1) and 254 point clouds for testing (folder Area_2). In the total dataset, tobacco has 105 point clouds, tomato has 326 point clouds, sorghum has 129 point clouds, soybean has 92 point clouds, and pepper has 237 point clouds. <br><br>
